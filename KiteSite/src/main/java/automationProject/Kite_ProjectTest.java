...
//
//public class Kite_ProjectTest extends OpenBrowser {
//	
//	LoginPage_1 login_1;
//	LoginPage2 login_2;
...
//	{
//		login_1.setUserName(Utility.Test_Data(0,0));
//		login_1.setPassword(Utility.Test_Data(0,1));
//		login_1.clickOnLoginBtn();
//		//Utility.captureScreenshot(driver, 1);
//		login_2.setPin(Utility.Test_Data(0, 2));
...
//		String expPn = Utility.Test_Data(0, 3);//KV
//		
